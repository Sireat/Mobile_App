...
import 'package:country_code_clone/features/country_code/presentation/bloc/country_code_event.dart';
...
class CountryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => CountryBloc(getCountryCode: CountryCode),
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                context.read<CountryBloc>().add(GetCountryCode() as CountryEvent);
              },
